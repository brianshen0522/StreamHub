...
dependencies {
    ...
    // Reading the pairing code off a television. zxing's `core` carries the
    // decoder as well as the encoder the TV app uses, so the scanner needs
    // CameraX for frames and nothing else for the reading.
