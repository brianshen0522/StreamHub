export const translations = {
  "zh-TW": {
    ...
    linkTv: "連結電視",
    linkTvDesc: "在電視上輸入配對碼，就不用拿遙控器打密碼",
    linkOpen: "輸入配對碼",
    linkTitle: "連結電視",
    linkSub: "在電視上掃描 QR Code，或把畫面上的配對碼輸入在這裡。",
    linkCodeLabel: "電視上顯示的配對碼",
    ...
    linkAnother: "再連結一台",
    linkBadCode: "配對碼看起來不對，請確認電視畫面上的八個字。",
    linkGoneCode: "這個配對碼已過期或已經用過了。請在電視上重新產生一組。",
    scanOpen: "掃描 QR Code",
    scanStop: "改用手動輸入",
    scanStarting: "開啟相機中…",
    scanHint: "把相機對準電視上的 QR Code。",
  ...
  en: {
    ...
    linkTv: "Connect a TV",
    linkTvDesc: "Enter the code your television is showing, instead of typing a password on a remote",
    linkOpen: "Enter a code",
    linkTitle: "Connect a TV",
    linkSub: "Scan the QR code on your television, or type the code it is showing.",
    linkCodeLabel: "The code on your television",
    ...
    linkBadCode: "That code does not look right — check the eight characters on your television.",
    linkGoneCode: "That code has expired or was already used. Get a fresh one on your television.",
    scanOpen: "Scan the code",
    scanStop: "Type it instead",
    scanStarting: "Starting the camera…",
    scanHint: "Point the camera at the code on your television.",
